...
from golden_retriever.serve.tokenizers.word import Word
...
class RegexTokenizer(BaseTokenizer):
    ...
    def __init__(self):
        ...
        self._regex = re.compile(r"\w+|\$[\d\.]+|\S+", re.UNICODE | re.MULTILINE | re.DOTALL)
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Example::
            ...
            >>> from golden_retriever.serve.tokenizers.regex_tokenizer import RegexTokenizer
