...
bash scripts/train.sh \
    ...
    "model_name=e5-base-mosaico-inbatch-first1M-wsd-random-hnprob0.2" \
    ...
    "data.datamodule.datasets.train.path=['/media/ssd/ric/data/golden/EL/mosaico/window_32_tokens/dpr/first_1M.jsonl']" \
